...
export default function Home() {
  return (
    <>
      ...
      <div className="splash-screen overflow-x-hidden text-center h-full w-full m-auto flex flex-col md:flex-row overflow-y-auto md:overflow-y-hidden bg-[#EAFDFC]">
        <div className="md:w-1/3 h-fit order-2 md:order-1">
          <div className="text-black text-md md:text-4xl px-7 py-12 mr-14 my-14">
            {APP_SUBTITLE}
          </div>
        </div>
